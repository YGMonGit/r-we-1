...
function Build() {
  return(
    <Box sx={{ width:"100%", height: "65%", display: "flex", justifyContent: "center", alignItems: "center", backgroundColor: "#1D212A", gap: "100px" }}>
      <img src={image_2} alt='Ethiopia map image' style={{ width: "30%", height: "auto", margin: "0 0 0 0" }} />
