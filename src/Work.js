...
function Work() {
  return(
    <Box sx={{ width:"100%", height: "78%", display: "flex", justifyContent: "flex-start", alignItems: "center", flexDirection: "column", margin: "20px 0 0 0" }}>
      <Box sx={{ height: "20%", minHeight: "105px", width: "100%", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
      ...
      <Box sx={{ width: "100%", flex: "1", display: "flex", alignItems: "flex-start", justifyContent: "space-evenly"}}>
        {WorkInfo.map((item) => (
          <Box sx={{ height: "85%", width: "180px", display: "flex", justifyContent: "flex-start", alignItems: "center", flexDirection: "column" }} key={item.id}>
            ...
            <Typography sx={{ color: "#333", fontSize: ".7rem", display: "flex", justifyContent: "center", alignItems: "flex-start", margin: "-5px 0 0 0", fontStyle: "italic" }}>Keeping copyright & Royalty</Typography>
          </Box>
        ))}
      </Box>
